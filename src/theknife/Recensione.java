...
/**
 * La classe {@code Recensione} rappresenta una recensione fatta da un utente
 * per un dato ristorante.
 * Gestisce la creazione, modifica, eliminazione e visualizzazione delle
...
public class Recensione {
     ...
     * 
     * @param usernameUtente      Username dell'utente che ha recensito il
     *                            ristorante.
     ...
     */
    public static boolean checkRisposta(String usernameUtente, String usernameRistoratore, String nomeRistorante)
            throws IOException {
        LinkedList<List<String>> listaRisposte = GestioneFile.getFileRisposteRecensioni();

        for (List<String> risposta : listaRisposte) {
            if (risposta.get(0).equalsIgnoreCase(usernameUtente) && risposta.get(1).equalsIgnoreCase(nomeRistorante)
                    && risposta.get(2).equalsIgnoreCase(usernameRistoratore)) {
                return true;
            }
        }
     ...
     * Se l'utente ha già scritto una recensione per quel ristorante, lancia
     * l'eccezione {@link RecensioneAlreadyExists}.
     * 
    ...
    public static void aggiungiRecensione(String nomeRistorante, Utente user)
        ...
        Utility.pulisci();Utility.printRecensione();
    ...
    /**
     * Modifica una recensione esistente. La elimina e richiede all'utente la nuova
     * recensione.
     * 
     ...
     */
    public static void modificaRecensione(Utente user, String nomeRistorante)
            throws IOException, RecensioneAlreadyExists {
        Scanner sc = new Scanner(System.in);
     ...
     * @param nomeRistorante   Nome del ristorante che viene recensito.
     * @param valutazione      Valutazione numerica (1-5) che viene passata come
     *                         stringa.
     ...
     * @throws IOException Se errore di I/O.
     */
    public static void scriviRisposta(Recensione recensione, String usernameRistoratore, String risposta)
            throws IOException {

        FileWriter fr = new FileWriter(GestioneFile.getPathRisposteRecensioni(), true);
        try {
            fr.write(recensione.getUser() + "," + "\"" + recensione.nomeRistorante + "\"" + "," + usernameRistoratore
                    + "," + "\"" + risposta + "\" " + "\n");
        } catch (IOException e) {
            System.out.println("Errore!!!!!");
        } finally {
    ...
    /**
     * Permette a un ristoratore di rispondere a una recensione, se non ha già
     * risposto.
     *
     ...
     * @return Una lista di liste di stringhe contenenti i dati delle recensioni
     *         dell'utente.
     ...
     * @return Una lista di liste di stringhe contenenti i dati delle recensioni del
     *         ristorante.
     * @throws IOException Se errore durante lettura del file.
     */
    ...
    /**
     * Consente a un utente di visualizzare le proprie recensioni, modificarle ed
     * eliminarle.
     *
     * @param user                 Utente.
            ...
            switch (input.toLowerCase()) {
                ...
                case "rispondi":
                    ...
                    if (checkRisposta(recensioneCorrente.getUser(), username, nomeRistorante)) {
                        Utility.pulisci();Utility.printError();
                        System.out.println("Errore: hai già scritto una risposta!\nPremi invio per continuare...");
                        sc.nextLine();
                        break;
                    }
