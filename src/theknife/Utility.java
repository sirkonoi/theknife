...
public class Utility {
    ...
    /*I CAMPI DA INSERIRE SONO: 
     LISTA_RISTORANTI_DA_VISUALIZZARE (listaFiltrati se scegli filtro, getRistoranti() se scegli preferiti), 
     tipoMenu ----> filtri (se vuoi stampare una lista filtrata) oppure preferiti (se vuoi stampare ristoranti preferiti)
     user ---> devi passare user dal main
     titolo ----> Il menu stampa Lista ristoranti + titolo quindi titolo = "filtrati" oppure "preferiti"
     mostraAddPreferiti = true / false , specifica se mostrare o meno il pulsante "Aggiungi ristorante ai preferiti"
    */
    public static void stampaRicerca(Ristorante ristoranti, String tipoMenu, GestioneUtenti user, String titolo,
            boolean mostraAddPreferiti) throws IOException {
        boolean stampa = true;
        ...
        while (stampa) {
            ...
            System.out.println("Lista ristoranti " + titolo + " (Pagina " + paginaCorrente + " di " + totalePagine + ")\n");
                ...
                case "cerca":
                    ...
                    if (!nomeRistorante.isEmpty() && Ristorante.checkRistoranti(nomeRistorante)) {
                        while (true) {
                            ...
                            if (scelta.equals("1") && mostraAddPreferiti && !user.getRuolo().equals("guest")) {
